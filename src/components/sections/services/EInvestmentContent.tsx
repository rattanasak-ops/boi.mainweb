...
/* ── FAQ items ── */
const faqItems = ["faq1", "faq2", "faq3"] as const;

export default function EInvestmentContent() {
  const t = useTranslations("e_investment_page.content");
          ...
          <div className="flex flex-col gap-4">
            {faqItems.map((faq, i) => (
              <motion.div
                ...
                className="bg-white border border-border hover:border-gold-300/60 transition-all duration-300 overflow-hidden"
                style={{ clipPath: BRAND_SHAPE }}
              >
                <button
                ...
                >
                  <h3 className="text-base sm:text-lg font-bold text-navy-600 group-hover:text-navy-950 transition-colors duration-300 pr-4">
                    {t(`${faq}_question`)}
                  </h3>
                  <motion.div
                    ...
                    className="shrink-0"
                  >
                    <ChevronDown className="h-5 w-5 text-navy-600/50" />
                  </motion.div>
                </button>
                  ...
                  {openFaq === i && (
                    ...
                    >
                      <div className="px-6 pb-6 border-t border-border/50">
                        <p className="pt-4 text-base text-text-secondary leading-relaxed">
                          {t(`${faq}_answer`)}
                        </p>
                      </div>
                    </motion.div>
