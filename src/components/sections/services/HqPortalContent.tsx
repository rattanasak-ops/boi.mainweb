...
/* ── HQ type cards ── */
const hqTypes = [
  { key: "type1", icon: Building },
  { key: "type2", icon: Globe },
  { key: "type3", icon: Briefcase },
] as const;

/* ── Benefits ── */
const benefits = ["benefit1", "benefit2", "benefit3", "benefit4", "benefit5"] as const;

export default function HqPortalContent() {
  const t = useTranslations("hq_portal_page.content");
