...
export default function ServicesHeroSection() {
  ...
  return (
    <section className="relative bg-navy-950 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-1/3 h-1/2 bg-gradient-to-tr from-gold-500/5 to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-6 sm:px-10 lg:px-20 pt-32 pb-16 sm:pb-20">
        ...
        <div className="max-w-3xl">
          ...
          <motion.h1
            className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white tracking-tight leading-[1.1]"
