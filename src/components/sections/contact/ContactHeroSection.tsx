        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            {CONTACT_INFO.map((info, i) => (
              ...
              >
                <div
                  className="p-5 bg-white/5 border border-white/[0.07] hover:border-gold-500/20 hover:bg-white/10 transition-all duration-300"
                  style={{ clipPath: BRAND_SHAPE }}
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gold-500/10 border border-gold-400/20 mb-3">
                    <info.icon
