...
export default function DiscoverHeroSection() {
  const t = useTranslations("discover_page.hero");
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/images/hero/expressway-city.jpg"
          alt=""
          fill
      ...
      >
        ...
        {/* Main heading */}
        <motion.h1
          className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white tracking-tight leading-[1.1] max-w-4xl"
